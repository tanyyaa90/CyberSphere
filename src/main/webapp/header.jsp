...
<%
    ...
    // Fallback chain: firstName → username → "Profile"
    if (firstName == null || firstName.isEmpty()) firstName = username;
    if (firstName == null || firstName.isEmpty()) firstName = "Profile";
    ...
    // Get context path for absolute URLs
...
<header class="cybersphere-header">
    <div class="header-container">
        ...
        <div class="logo-section">
            <a href="<%= ctxPath %>/home.jsp" class="logo-link">
        ...
        <nav class="header-nav">
            ...
            <!-- Profile Section - Using absolute path -->
